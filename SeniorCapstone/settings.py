"""
Django settings for SeniorCapstone project.
...
SECRET_KEY = '5m&nl_!bu%_bdib2ef$k$me_2wizdf@f)h%z1taz)yowg=8zu9'
...
ROOT_URLCONF = 'SeniorCapstone.urls'
...
WSGI_APPLICATION = 'SeniorCapstone.wsgi.application'
